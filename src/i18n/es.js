const es = {
  createPassword: {
    ...
    clipboardCleared: 'BORRAR PORTAPAPELES',
  },
  confirmationDialog: {
    completedStatus: '¡Completo!',
    completedClipboard: 'Contraseña generada ha sido copiado al portapapeles.',
    button: 'COMENZAR DE NUEVO',
  },
  passwordGenerator: {
    nickname: 'Apodo',
    password: 'Contraseña Maestra',
    confirmPassword: 'Confirma Contraseña Maestra',
    nicknameLabel: '¿Qué es el Apodo de la cuenta?',
    masterPassword: '¿Qué es la Contraseña Maestra?',
    submitMessage: 'GENERAR PASSWORD',
